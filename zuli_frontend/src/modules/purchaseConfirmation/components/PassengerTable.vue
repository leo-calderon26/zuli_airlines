<template>
  <section class="rounded-[18px] bg-white px-7 py-7 shadow-md">
    <div class="mb-6 flex items-center gap-3">
      <svg
        class="h-[12px] w-[24px] text-primary"
        viewBox="0 0 24 12"
        fill="none"
      ...
      <table class="w-full border-collapse">
        <thead>
          <tr class="bg-[#f3efef] text-left">
            <th class="px-5 py-4 text-[18px] font-semibold text-[#5a4847]">
              Pasajero
            </th>
            <th class="px-5 py-4 text-[18px] font-semibold text-[#5a4847]">
              Detalles
        ...
        <tbody>
          ...
          >
            <td class="px-5 py-5 align-top">
              <p class="text-[18px] font-semibold text-content">
                {{ passenger.fullName }}
              </p>
              ...
              <div class="flex items-center gap-6">
                <div class="flex items-center gap-1">
                  ...
                  <span class="text-[18px] font-semibold text-content">
                    x{{ passenger.checkedBaggageQuantity ?? 0 }}
                  </span>
                </div>
