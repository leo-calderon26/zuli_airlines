...
import { mockFlight } from '../mockData';
...
const contactErrors = computed(() => ({
    buyerName: errors.value.buyerName,
...
onMounted(() => {
    ...
    store.setFlight(mockFlight, 'Turista');
            ...
            <template v-else>
                <div class="col-span-8 space-y-6">
                    ...
                    <PassengerForm
                        ...
                        @update:buyerName="store.contactName = $event"
