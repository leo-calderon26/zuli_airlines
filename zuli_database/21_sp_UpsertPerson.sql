...
BEGIN
    ...
    IF @PersonId IS NULL
    BEGIN
        INSERT INTO dbo.Person (NationalId, FirstName, FirstLastName, SecondLastName, BirthDate, Gender)
        VALUES (@NationalId, @FirstName, @FirstLastName, @SecondLastName, @BirthDate, @Gender);
